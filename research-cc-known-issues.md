...
> Верифицировано по открытым issues в anthropics/claude-code (8 раундов ревью). Актуально на 24 февраля 2026. Все 35 ранее документированных issues проверены — open, описания совпадают. Добавлено 5 новых issues (#28148, #28093, #28078, #13890, #7881), найденных в 8-м ревью. Итого: 40 issues.
