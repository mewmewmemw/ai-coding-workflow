...
> Верифицировано по открытым issues в anthropics/claude-code (7 раундов ревью). Актуально на 24 февраля 2026. Все 33 ранее документированных issues проверены — open, описания совпадают. Добавлено 2 новых issues (#24220, #19298), найденных в 7-м ревью. Итого: 35 issues.
